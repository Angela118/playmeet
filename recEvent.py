...
#파일 불러오기 
file = open('C:/Users/SM-PC/GrdProject/recEvent.csv', 'r', encoding='UTF8')
...
#recOutput.csv에 저장 
with open('C:/Users/SM-PC/GrdProject/recOutput.csv','w', encoding='UTF8', newline='') as output:
